/// <summary>
/// Provides functions for transforming test ignore containers into formatted strings for reporting.
/// </summary>
...
/// <summary>
/// Transforms an ignored test into a formatted string for reporting.
/// </summary>
...
/// <returns>A formatted string representing the ignored test for reporting.</returns>
...
/// <summary>
/// Recursively transforms a test ignore container into a formatted string for reporting.
/// </summary>
...
/// <returns>A formatted string representing all ignored tests in the container for reporting.</returns>
...
/// <summary>
/// The default transformer for a single test ignore container with assembly context for reporting.
/// </summary>
/// <param name="assembly">The assembly context.</param>
/// <param name="indenter">The indenter used for formatting.</param>
/// <param name="container">The test ignore container to transform.</param>
...
/// <summary>
/// The default transformer for a single test ignore container using the calling assembly for reporting.
/// </summary>
/// <param name="indenter">The indenter used for formatting.</param>
/// <param name="container">The test ignore container to transform.</param>
/// <returns>A formatted string representing all ignored tests in the container for reporting.</returns>
...
/// <summary>
/// The default transformer for a list of test ignore containers using the calling assembly for reporting.
/// </summary>
/// <param name="indenter">The indenter used for formatting.</param>
/// <param name="containers">The list of test ignore containers to transform.</param>
/// <returns>A formatted string representing all ignored tests in the list of containers for reporting.</returns>
